...
public class Constants {
    ...
    public static class Icons {
        ...
        static {
            Icon artifactIconScaled = AllIcons.Nodes.Artifact instanceof ScalableIcon ? ((ScalableIcon) AllIcons.Nodes.Artifact).scale(LAYERED_ICON_SCALE_FACTOR) : AllIcons.Nodes.Artifact;
            Icon gearIconScaled = AllIcons.General.GearPlain instanceof ScalableIcon ? ((ScalableIcon) AllIcons.General.GearPlain).scale(0.5f) : AllIcons.General.GearPlain;
            Icon webIconScaled = AllIcons.General.Web instanceof ScalableIcon ? ((ScalableIcon) AllIcons.General.Web).scale(LAYERED_ICON_SCALE_FACTOR) : AllIcons.General.Web;

            CONFIG_ROOT_ICON = new LayeredIcon(2);
            CONFIG_ROOT_ICON.setIcon(PlatformIcons.FOLDER_ICON, 0);
            CONFIG_ROOT_ICON.setIcon(artifactIconScaled, 1, SwingConstants.SOUTH_EAST);

            CONFIG_LAYER_ROOT_ICON = new LayeredIcon(3);
            CONFIG_LAYER_ROOT_ICON.setIcon(PlatformIcons.FOLDER_ICON, 0);
            CONFIG_LAYER_ROOT_ICON.setIcon(artifactIconScaled, 1, SwingConstants.SOUTH_EAST);
            CONFIG_LAYER_ROOT_ICON.setIcon(gearIconScaled, 2, SwingConstants.NORTH_WEST);

            WEB_ROOT_ICON = new LayeredIcon(2);
            WEB_ROOT_ICON.setIcon(PlatformIcons.FOLDER_ICON, 0);
            WEB_ROOT_ICON.setIcon(webIconScaled, 1, SwingConstants.SOUTH_EAST);
        }
    }
